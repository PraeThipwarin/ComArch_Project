...
loop    add     1 5 1           // เอาตัวตั้ง - ตัวหาร
        ...
        nand    1 6 7           // ดูว่า MSB ของ ตัวตั้ง ว่าเป็น 1 หรือ 0 
        nand    7 7 7           //     
        beq     7 0 cont        // เอาไว้ดักเช็คว่า dvdnd - dvsor ตัว dvdnd มันมีค่าเป็น +,- เพื่อดูว่ามันน้อยกว่ายังหรือมากกว่ายัง
        add     1 2 1           // คืนค่าตัวตั้งกลับคืนมา (dvdnd = dvdnd + dvsor) เพราะว่าเราวนลูปเกินไป 1 รอบเลยต้องบวกคืน
        nand    0 0 7           // reg[7] = -1
        add     3 7 3           // ลบค่า quotient ที่เกินมา 1 ที่เกินมาจากการทำลูปรอบสุดท้าย
...
pos1    .fill   1
dvadr   .fill   div
sgnmsk  .fill   -2147483648  //ถ้าเก็บค่าได้มากสุด 16 bits ให้ใช้ค่า -65536 เพราะว่า -2^16 เป็น MSB
rtadr   .fill   0
